"""Conversation management and internal communication toolset.

All tools are prefixed with 'conversations_' to prevent naming collisions.
"""
...
# Create toolset
conversations_toolset = FunctionToolset()


@conversations_toolset.tool
async def escalate_to_human(
    ...
    Customer Interaction: Yes (handoff to human)
...
async def add_internal_note(
    ...
    Operation: WRITE (Creates internal message)
