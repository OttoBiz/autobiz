...
Usage:
    uv run services/db/migrate.py          # Run all pending migrations
    uv run services/db/migrate.py --rollback <version>  # Rollback to specific version
    uv run services/db/migrate.py --status  # Show migration status
"""
