...
def run_product_agent(customer_message, product_name, product_category, intent, tone, 
                      instruction=None, miscellaneous=None, use_internet=False, **kwargs):
    
    return product_agent.invoke({"customer_message": customer_message,
